...
/*   Updated: 2018/09/20 14:28:11 by cperrard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_len_ret_nbr(int nbflags, int lenbr, int c)
{
	if (nbflags == 7 && ft_s_len_ret(lenbr) != 0)
		...
		c = 0;
	else if (g_minfd == lenbr && nbflags == 1 && g_p == 0)
		c = 1;
